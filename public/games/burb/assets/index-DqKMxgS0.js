...
`;var Yl=document.querySelector(`.scene`),Xl=document.querySelector(`[data-speed]`);if(!Yl||!Xl)throw Error(`UI elements missing.`);var Zl=new vl({canvas:Yl,antialias:!0});Zl.setPixelRatio(Math.min(window.devicePixelRatio,2)),Zl.setSize(window.innerWidth,window.innerHeight),Zl.outputColorSpace=Le,Zl.toneMapping=4,Zl.toneMappingExposure=1.1;var Ql=new Nn;Ql.background=new q(`#87bfe8`),Ql.fog=new Mn(`#87bfe8`,70,380);var $l=new Pa(74,window.innerWidth/window.innerHeight,.1,1200);Ql.add($l);var eu=new Sa(`#d8efff`,`#31541f`,1.8);Ql.add(eu);var tu=new La(`#fff3d8`,2.2);tu.position.set(90,120,40),Ql.add(tu),Ql.add(Cl());var nu=new Ci([new W(0,0,0),new W(20,.5,28),new W(58,1.3,64),new W(108,2.1,54),new W(146,1.4,6),new W(136,.6,-52),new W(92,0,-92),new W(28,.7,-86),new W(-22,1.6,-54),new W(-72,2.3,-70),new W(-128,1.1,-36),new W(-146,.3,30),new W(-116,.9,92),new W(-56,1.8,118),new W(8,2.5,96),new W(54,1.8,132),new W(112,.9,162),new W(170,1.4,126),new W(192,2,58),new W(170,1.1,-16),new W(118,.2,-82),new W(42,-.2,-126),new W(-42,.4,-118),new W(-118,1.5,-88),new W(-188,1,-12),new W(-174,.5,82),new W(-100,1.4,150),new W(-6,2.1,176),new W(88,1.2,154)],!0,`centripetal`,.45),ru=nu.getLength();Ql.add(Ll(Zl.capabilities.getMaxAnisotropy())),Ql.add(Il(nu,Zl.capabilities.getMaxAnisotropy())),Ql.add(wl(nu)),Ql.add(Tl());var iu=yl();$l.add(iu.group);var au={accelerate:!1,brake:!1,left:!1,right:!1},ou={ArrowUp:`accelerate`,KeyW:`accelerate`,ArrowDown:`brake`,KeyS:`brake`,ArrowLeft:`left`,KeyA:`left`,ArrowRight:`right`,KeyD:`right`};window.addEventListener(`keydown`,e=>cu(e,!0)),window.addEventListener(`keyup`,e=>cu(e,!1));for(let e of document.querySelectorAll(`[data-control]`)){let t=e.dataset.control,n=e=>{t===`faster`&&(au.accelerate=e),t===`slower`&&(au.brake=e),t===`left`&&(au.left=e),t===`right`&&(au.right=e)};e.addEventListener(`pointerdown`,()=>n(!0)),e.addEventListener(`pointerup`,()=>n(!1)),e.addEventListener(`pointerleave`,()=>n(!1)),e.addEventListener(`pointercancel`,()=>n(!1))}var $={elapsed:0,progress:.02,speed:12,laneOffset:0,headingOffset:0,roll:0,steer:0},su=new eo;Zl.setAnimationLoop(()=>{let e=Math.min(su.getDelta(),.05);$.elapsed+=e;let t=Number(au.left)-Number(au.right),n=Number(au.accelerate)-Number(au.brake),r=Et.clamp(12+n*6.5,5,20);$.steer=Et.damp($.steer,t,6.5,e);let i=Et.clamp(Math.max(0,Math.abs($.laneOffset)-Hl*.5)/(Hl*.9),0,.45);$.speed=Et.damp($.speed,r*(1-i),3.6,e),$.headingOffset=Et.damp($.headingOffset,$.steer*Wl,5.4,e),$.laneOffset=Et.damp($.laneOffset,$.headingOffset*Hl*.55,2.8,e),$.progress=Et.euclideanModulo($.progress+$.speed*Math.max(.62,Math.cos($.headingOffset))*e/ru,1),$.roll=Et.damp($.roll,Et.clamp(-$.steer*.08,-Gl,Gl),7.2,e);let a=$.elapsed*($.speed*1.18),o=Math.sin(a)*.03,s=Math.sin(a*.5)*.018,c=nu.getPointAt($.progress),l=nu.getTangentAt($.progress).normalize(),u=new W().crossVectors(Kl,l).normalize(),d=l.clone().applyAxisAngle(Kl,$.headingOffset).normalize();$l.position.copy(c).addScaledVector(u,$.laneOffset+s).addScaledVector(Kl,Ul+o),ql.lookAt($l.position,$l.position.clone().add(d),Kl),$l.quaternion.setFromRotationMatrix(ql),$l.rotateZ(-$.roll),iu.group.rotation.set(0,0,0),iu.steerPivot.rotation.set(0,$.steer*.42,0),iu.group.position.y=-.75+o*.22,iu.group.position.x=s*.35;let f=74+($.speed-12)*.75;$l.fov=Et.damp($l.fov,f,3.2,e),$l.updateProjectionMatrix(),Xl.textContent=`${Math.round($.speed*3.6)} km/h`,Zl.render(Ql,$l)}),window.addEventListener(`resize`,()=>{$l.aspect=window.innerWidth/window.innerHeight,$l.updateProjectionMatrix(),Zl.setSize(window.innerWidth,window.innerHeight),Zl.setPixelRatio(Math.min(window.devicePixelRatio,2))});function cu(e,t){let n=ou[e.code];n&&(e.preventDefault(),au[n]=t)}