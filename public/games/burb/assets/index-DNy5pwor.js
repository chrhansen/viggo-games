...
void main() {
	...
	`}var Fo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new oi([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var mu=document.querySelector(`.scene`),hu=document.querySelector(`[data-speed]`),gu=document.querySelector(`.title`),_u=document.querySelector(`[data-dismiss-title]`),vu=document.querySelector(`[data-tilt-panel]`),yu=document.querySelector(`[data-tilt-button]`),bu=document.querySelector(`[data-tilt-status]`);if(!mu||!hu||!gu||!_u||!vu||!yu||!bu)throw Error(`UI elements missing.`);var xu=vu,Su=yu,Cu=bu;_u.addEventListener(`click`,()=>{gu.remove()});var wu=new vl({canvas:mu,antialias:!0});wu.setPixelRatio(Math.min(window.devicePixelRatio,2)),wu.setSize(window.innerWidth,window.innerHeight),wu.outputColorSpace=Ie,wu.toneMapping=4,wu.toneMappingExposure=1.1;var Tu=new Nn;Tu.background=new q(`#87bfe8`),Tu.fog=new Mn(`#87bfe8`,70,380);var Eu=new Pa(74,window.innerWidth/window.innerHeight,.1,1200);Tu.add(Eu);var Du=new Sa(`#d8efff`,`#31541f`,1.8);Tu.add(Du);var Ou=new La(`#fff3d8`,2.2);Ou.position.set(90,120,40),Tu.add(Ou),Tu.add(Vl());var ku=new Ci([[0,0],[20,28],[58,64],[108,54],[146,6],[136,-52],[92,-92],[28,-86],[-22,-54],[-72,-70],[-128,-36],[-146,30],[-116,92],[-56,118],[8,96],[54,132],[112,162],[170,126],[192,58],[170,-16],[118,-82],[42,-126],[-42,-118],[-118,-88],[-188,-12],[-174,82],[-100,150],[-6,176],[88,154]].map(([e,t])=>new W(e,0,t)),!0,`centripetal`,.45),Au=.02,ju=ku.getPointAt(Au),Mu=ku.getTangentAt(Au).normalize(),Nu=td(ku,720);Tu.add(Ol(wu.capabilities.getMaxAnisotropy())),Tu.add(Dl(ku,wu.capabilities.getMaxAnisotropy())),Tu.add(Hl(ku)),Tu.add(Ul());var Pu=yl();bl(Pu,iu),Eu.add(Pu.group);var Fu={accelerate:!1,brake:!1,left:!1,right:!1},Iu={ArrowUp:`accelerate`,KeyW:`accelerate`,ArrowDown:`brake`,KeyS:`brake`,ArrowLeft:`left`,KeyA:`left`,ArrowRight:`right`,KeyD:`right`},Lu=Wu(),Ru=Uu(),zu=window.isSecureContext?window.DeviceMotionEvent===void 0?`Motion sensors unavailable in this browser.`:null:`Tilt needs HTTPS or localhost.`,$={enabled:!1,pending:!1,permission:Lu?`idle`:`unsupported`,neutralAngle:null,currentAngle:null,targetSteer:0,smoothSteer:0,lastSampleAt:0};window.addEventListener(`keydown`,e=>Hu(e,!0)),window.addEventListener(`keyup`,e=>Hu(e,!1));for(let e of document.querySelectorAll(`[data-control]`)){let t=e.dataset.control,n=e=>{t===`faster`&&(Fu.accelerate=e),t===`slower`&&(Fu.brake=e),t===`left`&&(Fu.left=e),t===`right`&&(Fu.right=e)};e.addEventListener(`pointerdown`,()=>n(!0)),e.addEventListener(`pointerup`,()=>n(!1)),e.addEventListener(`pointerleave`,()=>n(!1)),e.addEventListener(`pointercancel`,()=>n(!1))}Ru&&(xu.hidden=!1,Su.addEventListener(`click`,()=>{if($.enabled){qu();return}Ku()}),Ju(),Lu&&`orientation`in window&&window.addEventListener(`orientationchange`,Yu),Lu&&screen.orientation?.addEventListener(`change`,Yu));var Bu={elapsed:0,speed:12,heading:Math.atan2(Mu.x,Mu.z),roll:0,steer:0,position:ju.clone()},Vu=new eo;wu.setAnimationLoop(()=>{let e=Math.min(Vu.getDelta(),.05);Bu.elapsed+=e;let t=Number(Fu.right)-Number(Fu.left);$.enabled&&performance.now()-$.lastSampleAt>uu&&($.targetSteer=0),$.smoothSteer=Et.damp($.smoothSteer,$.targetSteer,9,e);let n=t===0?$.smoothSteer:t,r=Number(Fu.accelerate)-Number(Fu.brake),i=Et.clamp(12+r*6.5,5,20);Bu.steer=Et.damp(Bu.steer,n,6.5,e),Bu.speed=Et.damp(Bu.speed,i,3.6,e),Bu.heading=Et.euclideanModulo(Bu.heading-Bu.steer*ou*e,Math.PI*2),Bu.roll=Et.damp(Bu.roll,Et.clamp(-Bu.steer*.08,-au,au),7.2,e);let a=Bu.elapsed*(Bu.speed*1.18),o=Math.sin(a)*.03,s=Math.sin(a*.5)*.018,c=new W(Math.sin(Bu.heading),0,Math.cos(Bu.heading)),l=new W().crossVectors(du,c).normalize();Bu.position.addScaledVector(c,Bu.speed*e),Bu.position.y=nd(Bu.position,Nu),Eu.position.copy(Bu.position).addScaledVector(l,s).addScaledVector(du,iu+o),fu.lookAt(Eu.position,Eu.position.clone().add(c),du),Eu.quaternion.setFromRotationMatrix(fu),Eu.rotateZ(-Bu.roll),Pu.group.rotation.set(0,0,0),Pu.steerPivot.rotation.set(0,-Bu.steer*.42,0),Pu.group.position.x=Pu.restPosition.x+s*.35,Pu.group.position.y=Pu.restPosition.y+o*.22,Pu.group.position.z=Pu.restPosition.z;let u=74+(Bu.speed-12)*.75;Eu.fov=Et.damp(Eu.fov,u,3.2,e),Eu.updateProjectionMatrix(),hu.textContent=`${Math.round(Bu.speed*3.6)} km/h`,wu.render(Tu,Eu)}),window.addEventListener(`resize`,()=>{Eu.aspect=window.innerWidth/window.innerHeight,Eu.updateProjectionMatrix(),wu.setSize(window.innerWidth,window.innerHeight),wu.setPixelRatio(Math.min(window.devicePixelRatio,2))});function Hu(e,t){let n=Iu[e.code];n&&(e.preventDefault(),Fu[n]=t)}function Uu(){return window.matchMedia(`(pointer: coarse)`).matches||navigator.maxTouchPoints>0}function Wu(){return Uu()&&window.isSecureContext&&window.DeviceMotionEvent!==void 0}function Gu(){return window.DeviceMotionEvent}async function Ku(){if(!Lu||$.pending)return;$.pending=!0,Ju();let e=`Hold phone upright for a moment to center tilt.`;try{let t=Gu();if(typeof t?.requestPermission==`function`&&await t.requestPermission()!==`granted`){$.permission=`denied`,e=`Motion access denied. Touch steering still works.`;return}$.enabled||=(window.addEventListener(`devicemotion`,Xu,{passive:!0}),!0),$.permission=`granted`,$.targetSteer=0,$.smoothSteer=0,$.neutralAngle=null,$.currentAngle=null,$.lastSampleAt=0}catch(t){$.permission=`denied`,e=`Motion access failed${t instanceof Error&&t.message?`: ${t.message}`:`.`}`}finally{$.pending=!1,Ju(e)}}function qu(){$.neutralAngle=$.currentAngle,$.targetSteer=0,$.smoothSteer=0,Ju($.neutralAngle===null?`Hold phone upright for a moment to center tilt.`:`Tilt recentered. Lean 30-45 degrees to steer.`)}function Ju(e){if(!Ru){xu.hidden=!0;return}if(xu.hidden=!1,!Lu){Su.disabled=!0,Su.textContent=`Tilt unavailable`,Cu.textContent=zu??`Tilt unavailable here.`;return}if($.pending?(Su.disabled=!0,Su.textContent=`Enabling tilt...`):$.enabled?(Su.disabled=!1,Su.textContent=`Recenter tilt`):(Su.disabled=!1,Su.textContent=$.permission===`denied`?`Retry tilt`:`Enable tilt`),e){Cu.textContent=e;return}if($.permission===`denied`){Cu.textContent=`Motion access denied. Use touch buttons or retry tilt.`;return}if($.enabled&&$.neutralAngle===null){Cu.textContent=`Hold phone upright. Neutral sets automatically.`;return}Cu.textContent=`Lean phone 30-45 degrees to steer. Back upright to go straight.`}function Yu(){$.enabled&&($.neutralAngle=null,$.currentAngle=null,$.targetSteer=0,$.smoothSteer=0,Ju(`Orientation changed. Hold phone upright to recenter tilt.`))}function Xu(e){let t=e.accelerationIncludingGravity;if(!t)return;let n=Zu(t);n!==null&&($.currentAngle=n,$.lastSampleAt=performance.now(),$.neutralAngle===null&&($.neutralAngle=n,Ju(`Tilt steer on. Lean left or right to carve.`)),$.targetSteer=ed($u(n,$.neutralAngle)))}function Zu(e){if(e.x===null||e.y===null)return null;let t=Et.degToRad(Qu()),n=e.x*Math.cos(t)-e.y*Math.sin(t),r=e.x*Math.sin(t)+e.y*Math.cos(t);return Math.hypot(n,r)<lu?null:Et.radToDeg(Math.atan2(n,-r))}function Qu(){if(typeof screen.orientation?.angle==`number`)return screen.orientation.angle;let e=window.orientation;return typeof e==`number`?Et.euclideanModulo(e,360):0}function $u(e,t){return Et.euclideanModulo(e-t+180,360)-180}function ed(e){let t=Et.clamp(e,-cu,cu),n=Math.abs(t);return n<=su?0:(n-su)/(cu-su)*Math.sign(t)}function td(e,t){let n=[];for(let r=0;r<t;r+=1){let i=e.getPointAt(r/t);n.push({position:i,surfaceHeight:i.y+Cl})}return n}function nd(e,t){let n=1/0,r=0;for(let i of t){let t=e.x-i.position.x,a=e.z-i.position.z,o=t*t+a*a;o<n&&(n=o,r=i.surfaceHeight)}let i=Math.sqrt(n),a=1-Et.smoothstep(i,ru*.45,ru*.95);return Et.lerp(0,r,a)}